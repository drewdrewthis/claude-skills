...
If the project has coding standards or conventions, read them before reviewing. Look for:
...
- Does it respect local project conventions (check ADRs if available)?
