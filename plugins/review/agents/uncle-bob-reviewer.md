...
If the project has coding standards, testing philosophy, or ADR documents, read them before reviewing. Look for:
- `AGENTS.md` or `CLAUDE.md` - common mistakes to avoid
- `docs/CODING_STANDARDS.md` or similar - project conventions
- `docs/TESTING_PHILOSOPHY.md` or similar - testing hierarchy
...
- **ADRs**: Check for relevant ADRs. Does implementation match documented decisions?
- **Docs**: Are public APIs documented? Do docs match actual behavior?
...
Adapt to the project's language. For TypeScript:
